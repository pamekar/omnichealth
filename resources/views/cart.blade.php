...
@section('title', 'Your Shopping Cart - OMNIC Medical Store')
            ...
            <div class="container">
                ...
                @if(count($cartItems) > 0)
                                ...
                                <div class="cart-item">
                                    ...
                                    <div class="item-remove">
                                        <form action="{{ route('cart.remove') }}" method="POST">
                                            ...
                                            <button type="submit" class="btn-remove" aria-label="Remove item"><i
                    ...
                    <div class="cart-actions" data-aos="fade-up">
                        <a href="{{ route('shop.index') }}" class="btn-continue-shopping"><i
