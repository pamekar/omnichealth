    ...
    <div class="welcome-page">
        ...
        <section class="hero-section">
            ...
            <div class="hero-content container">
                ...
                <a href="{{ route('shop.index') }}" wire:navigate class="btn btn-primary" data-aos="zoom-in" data-aos-delay="400">Shop
                    All Products</a>
            </div>
        </section>
                            ...
                            <div class="product-card" data-aos="fade-up"
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-footer">
                                        ...
                                        @endif
                                        @livewire('add-to-cart-button', ['productId' => $product->id], key('add-to-cart-welcome-'.$product->id))
                                    </div>
                                </div>
                            </div>
                        @endforeach
