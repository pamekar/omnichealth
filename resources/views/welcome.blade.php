...
<div class="welcome-page">
    ...
    <section class="hero-section">
        ...
        <div class="hero-content container">
            ...
            <p data-aos="fade-up" data-aos-delay="200">Providing the highest quality medical equipment and consumables to professionals and individuals.</p>
            <a href="{{ route('shop.index') }}" class="btn btn-primary" data-aos="zoom-in" data-aos-delay="400">Shop All Products</a>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="product-grid">
                ...
                @empty
                    <p class="text-center text-gray-500 col-span-full">No trending products available at the moment.</p>
                @endforelse
            </div>
